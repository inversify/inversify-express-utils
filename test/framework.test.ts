...
describe('Integration Tests:', () => {
  ...
  describe('Routing & Request Handling:', () => {
    ...
    it('should use custom routing configuration', (): void => {
      @controller('/ping')
      class TestController {
        @httpGet('/endpoint') public get() {
          return 'pong';
      ...
      return void supertest(server.build())
  ...
  describe('Middleware:', () => {
    ...
    it('should resolve controller-level middleware', (): void => {
    ...
    it('should resolve method-level middleware', (): void => {
      const symbolId = Symbol.for('spyA');
      const strId = 'spyB';
    ...
    it('should compose controller- and method-level middleware', (): void => {
      const symbolId = Symbol.for('spyA');
      const strId = 'spyB';
  ...
  describe('Parameters:', () => {
    it('should bind a method parameter to the url parameter of the web request', done => {
      ...
      class TestController {
        @httpGet(':id')
        public getTest(
          @requestParam('id') id: string, req: Request, res: Response) {
          return id;
        }
      }
